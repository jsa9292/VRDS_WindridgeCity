Shader "Hidden/VolumetricLightBeamSRP"
{
    Properties
    {
    ...
    Category
    {
        ...
        SubShader
        {
            Tags
            {
                "RenderPipeline" = "UniversalPipeline,LightweightPipeline"
                "Queue" = "Transparent"
            ...
            Pass
            {
                ...
                #pragma multi_compile __ VLB_OCCLUSION_CLIPPING_PLANE VLB_OCCLUSION_DEPTH_TEXTURE
