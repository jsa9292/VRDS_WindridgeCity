...
namespace VLB
{
    public static class MaterialManager
    {
        ...
        static int kStaticPropertiesCount = (int)BlendingMode.Count * (int)DepthBlend.Count * (int)ColorGradient.Count * (int)DynamicOcclusion.Count * (int)DynamicOcclusion.Count;
