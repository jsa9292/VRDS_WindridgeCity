...
namespace VLB
{
    public static class EditorExtensions
    {
        ...
        public static void Menu_AddDynamicOcclusion_Raycasting(MenuCommand menuCommand)
        {
            var vlb = menuCommand.context as VolumetricLightBeam;
            if (vlb)
                vlb.gameObject.AddComponent<DynamicOcclusionRaycasting>();
        }

        [MenuItem("CONTEXT/VolumetricLightBeam/Add Dynamic Occlusion (Depth Buffer)")]
        public static void Menu_AddDynamicOcclusion_DepthBuffer(MenuCommand menuCommand)
        {
            var vlb = menuCommand.context as VolumetricLightBeam;
            if (vlb)
                vlb.gameObject.AddComponent<DynamicOcclusionDepthBuffer>();
        }
